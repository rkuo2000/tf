...
# $pip install mtcnn
# $python mtcnn_emotion_detection images/facemask1.jpg
import sys
import cv2
import numpy as np
...
for box in bbox:
    ...
    cv2.putText(img, txt, (x,y+10), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2) # font scale=1, thickness=2
    cv2.putText(img, acc, (x,y+h), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2) # font scale=1, thickness=2
