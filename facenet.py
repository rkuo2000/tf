### Download some faces .jpg in ~/tf/datasets/faces
### $cd ~/tf
### $git clone https://github.com/sainimohit23/FaceNet-Real-Time-face-recognition
### $cp -rf FaceNet-Real-Time-face-recognition/weights .
### $python facenet.py
