# Yolo V3 in Tensorflow
# download https://www.kaggle.com/aruchomu/data-for-yolo-v3-kernel
# put yolov3.weights, coco.names, futur.ttf, dog.jpg, office.jpg into ~/tf
import numpy as np
...
for img in img_names: Image.open(img).show()
