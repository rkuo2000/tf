...
# Load Model
model = models.load_model('models/gesture_game.h5')
...
# read images
img_paper = cv2.imread('images/paper.jpg')
img_rock  = cv2.imread('images/rock.jpg')
img_scissors = cv2.imread('images/scissors.jpg')
