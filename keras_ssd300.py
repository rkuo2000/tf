...
from tensorflow.keras_layers.keras_layer_AnchorBoxes import AnchorBoxes
from tensorflow.keras_layers.keras_layer_L2Normalization import L2Normalization
from tensorflow.keras_layers.keras_layer_DecodeDetections import DecodeDetections
from tensorflow.keras_layers.keras_layer_DecodeDetectionsFast import DecodeDetectionsFast
...
def ssd_300(image_size,
    ...
    In case you're training the network, the parameters passed here must be the same as the ones used to set up `SSDBoxEncoder`. 
    In case you're loading trained weights, the parameters passed here must be the same as the ones used to produce the trained weights.
    Some of these arguments are explained in more detail in the documentation of the `SSDBoxEncoder` class.

    Note: Requires Keras v2.0 or later. Currently works only with the TensorFlow backend (v1.0 or later).
