...
train_path = 'data/ham10000/train'
valid_path = 'data/ham10000/val'
...
filepath = "model/skin_lesion_wt.h5"
...
# Save Model
model.save('model/skin_lesion.h5')

# Evaluation of the best epoch
model.load_weights('model/skin_lesion_wt.h5')
