...
print("--- head ---")
print(hsv[149,163]) # [y,x]
print(hsv[ 73,483]) # [y,x]
print(hsv[152,211]) # [y,x]
print(hsv[ 72,520]) # [y,x]

print("--- arm ---")
print(hsv[337, 49]) # [y,x]
print(hsv[214,419]) # [y,x]
print(hsv[296,319]) # [y,x]
print(hsv[341,330]) # [y,x]
